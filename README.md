...
<!-- Hero Banner -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,2,30&height=200&section=header&text=lanshu-awesome-ai-video-kit&fontSize=42&fontColor=ffffff&fontAlignY=38&desc=AI%20Video%20Prompt%20Engineering%20Kit%20·%2015%20Models%20·%20421%20Prompts&descSize=15&descAlignY=62&descColor=cccccc">
...
421 实测 prompt · 15 模型 · 7 Claude Skill · 15 篇方法论 · GitHub Action 每周自动监控官方端点
...
[![Prompts](https://img.shields.io/badge/Prompts-421-fb923c?style=flat-square)](prompts/)
...
```
421 条 prompt   (311 单模型最佳实践 + 110 跨模型对照矩阵)
...
| 工具 | 路径 | 卖点 |
|---|---|---|
| **Prompt Browser** | [`tools/prompt-browser/`](tools/prompt-browser/) | 421 prompt 浏览器 · 15 模型彩虹筛选 · URL 状态分享 · 键盘导航(`/`/`j`/`k`/`Enter`/`c`)|
...
│
├── prompts/
│   ├── data/all-prompts.json       # 单一数据源(421 条)
